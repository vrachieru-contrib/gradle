...
public class ResourceConnectorRepositoryTransport extends AbstractRepositoryTransport {
    ...
    public ResourceConnectorRepositoryTransport(String name,
                                                ...
                                                ImmutableModuleIdentifierFactory moduleIdentifierFactory, ProducerGuard<URI> producerGuard) {
        super(name);
        ...
        resourceAccessor = new DefaultCacheAwareExternalResourceAccessor(repository, cachedExternalResourceIndex, timeProvider, temporaryFileProvider, cacheLockingManager, moduleIdentifierFactory, producerGuard);
    }
